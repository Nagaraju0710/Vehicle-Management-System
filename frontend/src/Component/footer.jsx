    ...
    <div className='footer' >
        <div className='left-side'>
            <div className='info'>
                <div className="text">
                    ...
                    <p>dolor sit amet.</p>
                    <p>About TransUnion Vehicle Managment</p>
        ...
        <div className='right-side'>
            ...
            <div className='copy-right'>
                <p>© Copyright 2023 Vehicle Management Limited (Formerly: Vehicle Managament Information Bureau (India) Limited). All Rights Reserved.</p>
            </div>
        </div>
    </div>
  )
